...
<section class="wrapper">
    <div class="content-wrapper">
        ...
        <div class="wrapper-container">
            ...
            <table id="category_list" class="table is-striped table-hover" style="width: 100%">
                <thead>
                    <tr>
...
<script src="<?php echo PUBLIC_ROOT.'js/category.js'?>"></script> 
    ...
    <script>
         function loadTable(){
          const table = $('#category_list').DataTable({
                ...
                'ajax' : {
                    'url': "<?php echo PUBLIC_ROOT.'category/ajaxList'?>",
                    'type': 'POST',
                },
                'columnDefs' : [
                    {
            ...
            $("#sort").click(function(){
                $("#sort-opt").empty()
                let i= 1;
                var n = $('#category_list thead th').length;
                for(i = 1; i<n; i++){
