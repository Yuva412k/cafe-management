...
<section class="wrapper">
    <div class="content-wrapper">
        <div class="content-header">
            <h2>Purchase Payments Report</h2>
        </div>
...
<script>
    ...
    var payment_status = document.getElementById("payment_status").value.trim();
        ...
        $.post("showPurchasePaymentsReport",{supplier_id:supplier_id,payment_status:payment_status,from_date:from_date,to_date:to_date},function(result){
          //alert(result);
            setTimeout(function() {
