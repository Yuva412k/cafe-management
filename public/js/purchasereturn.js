...
function pay_now(purchase_id){
  $.post('purchaseReturn/show_pay_now_modal', {purchase_id: purchase_id}, function(result) {
...
function view_payments(purchase_id){
  $.post('purchaseReturn/view_payments_modal', {purchase_id: purchase_id}, function(result) {
...
function save_payment(purchase_id){
  var base_url=$("#baseUrl").val().trim();
   ...
   //Validate Input box or selection box should not be blank or empty
    ...
    $.post('purchaseReturn/save_payment', {return_id: return_id,payment_type:payment_type,amount:amount,payment_date:payment_date,payment_note:payment_note}, function(result) {
      result=result.trim();
  //alert(result);return;
        if(result=="success")
        {
