...
<section class="wrapper">
    <div class="content-wrapper">
        ...
        <div class="table-header">
            ...
            <table id="purchase_list" class="table is-striped table-hover" style="width: 100%">
                <thead>
                    <tr>
...
<script>
    ...
    <script>
         function loadTable(){
          const table = $('#purchase_list').DataTable({
                ...
                'ajax' : {
                    'url': "<?php echo PUBLIC_ROOT.'purchase/ajaxList'?>",
                    'type': 'POST',
                },
                'columnDefs' : [
                    {
            ...
            $("#sort").click(function(){
                $("#sort-opt").empty()
                let i= 1;
                var n = $('#purchase_list thead th').length;
                for(i = 1; i<n; i++){
