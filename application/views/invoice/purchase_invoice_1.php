...
<html>
    ...
    <body >
        ...
        <table style="width: 210mm;margin-left: auto;margin-right: auto;">
            <thead>
                <tr>
                     <th style="font-size: 30px;text-align:left" colspan="4">Purchase Invoice </th>
                </tr>
               <tr>
                   <td colspan="4">
                    Invoice No : <?=$purchase_id?><br>
            ...
            <tr style="border-bottom: 2px solid #ccc; border-spacing: 5px;">
                <?php
                    ...
                    foreach($purchase_items as $res){
                        ...
                        echo "<td style='text-align:right'>".$res['purchase_qty']."</td>";
                    ...
                    $tot_purchase_price += $res['price_per_unit'];
