<?php
    ...
    if(!isset($id)){
        $customer_id=$sales_status=$reference_no=$other_charges_amt=$other_charges_input=$other_charges_type=$discount_type=$discount_on_all_input=$discount_on_all_amt=$discount_on_all_type=$tax_id=$sales_status='';
            ...
            <form id="sales-form" enctype="multipart/form-data">
                ...
                <div class="header">
                    ...
                    <div class="item-pair">
                        ...
                        <input type="date" name="sales_date" id="sales_date" value="<?php print $sales_date ?>">
                    </div>
