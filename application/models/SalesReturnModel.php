...
<?php
    ...
    public function invoiceDetails($return_id)
    {
        ...
        $sales_items_query = "SELECT b.item_name, a.return_qty, a.price_per_unit, a.discount_input, a.discount_amt, a.unit_total_cost, a.total_cost FROM salesreturnitems AS a, items AS b WHERE b.`item_id`=a.`item_id` AND a.return_id='$return_id'";
    ...
    {
        $q1 = "SELECT * FROM salesreturn WHERE return_id='$return_id'";
        $this->db->prepare($q1);
        $this->db->execute();
...
<div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <h4>Customer Details</h4><br>
            ...
            <div class="modal-row" style="width: 100%;">
                ...
                <tbody>
                    <?php 
                        $q5 = "SELECT * FROM salesreturnpayments WHERE return_id='$return_id' and payment>0";
                        $i = 1;
                        $str = '';
                        $this->db->prepare($q5);
                        $this->db->execute();
    ...
    public function createSalesReturnID()
    {
        ...
        $this->db->prepare("SELECT sales_return_prefix FROM shopdetails");
        $this->db->execute();
        $prefix = $this->db->fetchAssociative()['sales_return_prefix'];
