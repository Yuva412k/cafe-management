            ...
            <form class="validate-form" enctype="multipart/form-data">
                ...
                <div class="header">
                    ...
                    <div class="item-pair">
                        ...
                        <input type="date" class="req-input" style="width:100%" name="to_date" id="to_date" value="<?php echo date("Y-m-d")?>">
                        </div>
                    </div>
                    <div class="item-pair">
...
<script>
    ...
    var item_id=document.getElementById("item_id").value.trim();
        ...
        $.post("showExpiredProductsReport",{item_id:item_id,to_date:to_date},function(result){
          //alert(result);
            setTimeout(function() {
