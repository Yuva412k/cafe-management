...
<section class="wrapper">
    <div class="content-wrapper">
        ...
        <div class="table-header">
            ...
            <table id="paymenttype_list" class="table is-striped table-hover" style="width: 100%">
                <thead>
                    <tr>
...
<script src="<?php echo PUBLIC_ROOT.'js/paymenttype.js'?>"></script> 
    ...
    <script>
         function loadTable(){
          const table = $('#paymenttype_list').DataTable({
                ...
                'ajax' : {
                    'url': "<?php echo PUBLIC_ROOT.'paymenttype/ajaxList'?>",
                    'type': 'POST',
                },
                'columnDefs' : [
                    {
            ...
            $("#sort").click(function(){
                $("#sort-opt").empty()
                let i= 1;
                var n = $('#paymenttype_list thead th').length;
                for(i = 1; i<n; i++){
