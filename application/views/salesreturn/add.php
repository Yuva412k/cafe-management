<?php
    ...
    if($request_name=='update'){  
        ...
        $reference_no=$other_charges_amt=$other_charges_input=$other_charges_type=$discount_type=$discount_on_all_input=$discount_on_all_amt=$discount_on_all_type=$tax_id=$return_status='';
        $return_date=date('Y-m-d');
    }
?>
            ...
            <form id="sales-form" class="validate-form" enctype="multipart/form-data">
                ...
                <div class="header">
                    <div class="item-pair">
                        ...
                        <select name="customer_id" id="customer_id" style="width: 100%;">
                    ...
                    <div class="item-pair">
                        ...
                        <input type="text" class="req-input" style="width:100%" name="sales_id" id="sales_id" readonly value="<?php print $sales_id ?>" >
                        </div>
                    </div>
                    <?php endif;?>
                    <div class="item-pair">
                    ...
                    <div class="item-pair">
                        ...
                        <select name="return_status" id="return_status" class="select" style="width: 100%;">
                           <?php
                            $selectreturn = '';
                            $selectcancel = '';
                ...
                <div class="salesreturn-table tb-h10">
                    ...
                    <div class="payment_box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="amount_div">
                                        ...
                                        <div style="width:100%">
                                        <input onkeyup="calculate_balance()" class="number" type="text" style="width: 100%;" id="amount" name="amount" placeholder="" >
                                        </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="btn-container">
                    <div class="btn"><a href="<?php echo PUBLIC_ROOT.'salesReturn' ?>" id='button'>Cancel</a></div>
